...
export const PROJECT_SETTINGS: Record<TProjectSettingsTabs, TProjectSettingsItem> = {
  ...
  integrations_backlog: {
    key: "integrations_backlog",
    i18n_label: "project_settings.integrations.backlog.title",
    href: `/integrations/backlog`,
    access: [EUserProjectRoles.ADMIN],
    highlight: (pathname: string, baseUrl: string) => pathname.startsWith(`${baseUrl}/integrations/backlog`),
  },
  integrations_github: {
    key: "integrations_github",
    i18n_label: "project_settings.integrations.github.title",
    href: `/integrations/github`,
    access: [EUserProjectRoles.ADMIN],
    highlight: (pathname: string, baseUrl: string) => pathname.startsWith(`${baseUrl}/integrations/github`),
  },
};
...
export const GROUPED_PROJECT_SETTINGS: Record<PROJECT_SETTINGS_CATEGORY, TProjectSettingsItem[]> = {
  ...
  [PROJECT_SETTINGS_CATEGORY.EXECUTION]: [
    ...
    PROJECT_SETTINGS["integrations_backlog"],
    PROJECT_SETTINGS["integrations_github"],
  ],
};
