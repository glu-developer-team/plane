...
export default {
  ...
  project_settings: {
    ...
    integrations: {
      backlog: {
        title: "Backlog",
        heading: "Backlog integration",
        description: "Connect this project to a Backlog space to sync issues and comments.",
        space_host: "Backlog space host",
        space_host_placeholder: "your-space.backlog.com",
        api_key: "API key",
        api_key_placeholder: "Enter Backlog API key",
        ...
        sync_mode_bidirectional: "Two-way sync",
        sync_mode_bidirectional_hint: "Pull from Backlog and push Plane edits and comments to Backlog.",
        save: "Test & save",
        disconnect: "Disconnect",
        saving: "Saving...",
        saved: "Backlog connection saved",
        disconnected: "Backlog disconnected",
        locale_heading: "Japanese ↔ English mapping",
        locale_description:
          "Backlog uses Japanese; Plane uses English. Default terms apply to all projects. Add custom terms for titles and phrases used in your team.",
        locale_save_hint: "Edit the fields below, then click Save to apply.",
        locale_default_heading: "Default terms",
        locale_default_hint: "Japanese is fixed. Edit the English label used in Plane.",
        locale_custom_heading: "Custom terms",
        locale_custom_hint: "Add team-specific Japanese phrases and their English equivalents.",
        locale_status_heading: "Synced statuses (from Backlog)",
        locale_status_hint:
          "Edit how each Backlog status appears in Plane. Unmapped statuses keep their Japanese name until you set English here.",
        locale_japanese: "Japanese (Backlog)",
        locale_english: "English (Plane)",
        locale_japanese_placeholder: "例: 要望",
        locale_english_placeholder: "e.g. Request",
        locale_add_row: "Add term",
        locale_add_first: "Click to add your first custom term",
        locale_remove_row: "Remove",
        locale_no_custom: "No custom terms yet.",
        locale_no_status: "Save the connection to sync statuses from Backlog.",
      },
      github: {
        title: "GitHub PR",
        heading: "GitHub PR integration",
        description:
          "Link pull requests to Plane tasks using [PROJECT-N] tags in the PR title or body. Sync comments bidirectionally.",
        repo_owner: "Repository owner",
        repo_owner_placeholder: "e.g. glu-developer-team",
        repo_name: "Repository name",
        repo_name_placeholder: "e.g. plane",
        installation_id: "GitHub App installation ID",
        installation_id_placeholder: "Set automatically after Connect GitHub (PR 2)",
        installation_id_hint: "Optional until GitHub App install is wired. Required for webhooks.",
        enabled: "Enable sync",
        sync_mode: "Sync direction",
        sync_mode_github_to_plane: "GitHub → Plane only",
        sync_mode_github_to_plane_hint:
          "Pull PR links and comments from GitHub. Plane comments are not pushed to GitHub.",
        sync_mode_bidirectional: "Two-way sync",
        sync_mode_bidirectional_hint: "Sync PR comments to Plane and push Plane task comments to the PR.",
        save: "Save",
        disconnect: "Disconnect",
        saving: "Saving...",
        saved: "GitHub PR connection saved",
        disconnected: "GitHub PR sync disconnected",
